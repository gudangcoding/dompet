...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      <span class="logo-mini"><b>Atomic</b></span>
     <span class="logo-lg"><b>Atomid</b>ID</span>
    </a>
        ...
        <li><a href="{{ route('home') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Dompet</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Kategori</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
            <i class="fa fa-list"></i> <span>Tansaksi</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i> Dompet Masuk</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Dompet Keluar</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
